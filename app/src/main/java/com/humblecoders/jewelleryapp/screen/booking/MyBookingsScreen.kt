            ...
            Column(
                ...
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            "Upcoming appointments with our jewelry experts",
                ...
                if (isLoading) {
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            Spacer(modifier = Modifier.height(8.dp))
                            Text(
                                "You don't have any scheduled video consultations yet. Book a slot to get personalized jewelry advice!",
                                style = MaterialTheme.typography.bodyMedium,
...
@Composable
private fun BookingCard(booking: BookingDoc) {
    val df = SimpleDateFormat("EEE, dd MMM yyyy 'at' HH:mm", Locale.getDefault())
    val start = df.format(Date(booking.startTime.seconds * 1000))
    val end = df.format(Date(booking.endTime.seconds * 1000))
